...
export default function LoginPage() {
  ...
  async function handleGoogleLogin() {
    ...
    await signIn('google', { callbackUrl: '/compiler' });
  }
    ...
    <div style={bg}>
      <div style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={sub}>Pick up where you left off</p>
        </div>

        <div style={card}>
          <button onClick={handleGoogleLogin} disabled={googleLoading || loading} style={googleBtn}>
            <GoogleIcon />
        ...
        <p style={switchText}>
          ...
          <a href="/signup" style={switchLink}>Sign up free</a>
        </p>
      </div>
    </div>
  );
